...
//Open Closed Principle - The system have to be open for extensions but should be closed for modifications
namespace SOLID_O
{
    public enum Color
    {
    ...
    // introducing two new interfaces that are open for extension
